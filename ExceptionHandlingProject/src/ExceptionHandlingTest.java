...
class Home
{
    ...
    void startTheJourney() {
        ...
        Car car;
                ...
                } catch (BatteryProblemException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
            } 
            catch (CarDocumentException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            }
...
class Car
{
    ...
    Car() throws CarKeyNotFoundException, CarDocumentException,BatteryProblemException
    {
    ...
    void longDrive() throws BatteryProblemException //no throws here
    {
        for (int i = 1; i <= 50; i++) {
...
//                throw new RuntimeException("Oh!!! fuel ran out....can't go now..");
            ...
            if(val<0.50) {
//                throw new RuntimeException("Oh!!! fuel ran out....can't go now..");
                throw new BatteryProblemException("Oops! Battery damage");
